...
('THEME_MANAGEMENT','theme.adminFeature.theme_management.name',0,'jsp/admin/plugins/theme/ManageThemes.jsp','theme.adminFeature.theme_management.description',1,'theme','STYLE','ti ti-brush', NULL);
